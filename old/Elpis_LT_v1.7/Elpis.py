...
from flask import Flask, make_response,request,abort, redirect, url_for, make_response,session,Blueprint
app = Flask(__name__)
cors = CORS(app)
...
app.register_blueprint(document.doc, url_prefix="/")
app.register_blueprint(document.doc_static, url_prefix="/")
app.register_blueprint(document.doc_images, url_prefix="/")
from APIs import ElpisAPI
app.register_blueprint(ElpisAPI.app, url_prefix="/api")
